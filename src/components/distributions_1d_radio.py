...
def render(app: Dash) -> html.Div:
    @app.callback(
        Output(ids.DISTRIBUTIONS_1D_INFO, "children"),
    ...
    return html.Div(
        children=[
            html.H5("1. Select Spotify Audio Feature:", className="mb-2"),
            html.Div(
                [
                    dbc.RadioItems(
                        id=ids.DISTRIBUTIONS_1D_RADIO,
